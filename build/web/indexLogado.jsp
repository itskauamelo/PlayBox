                            ...
                            <label>
                                Você deseja:
                                    <div class="modal-footer">
                                        <a href="assinar?id=3" type="submit" class="btn btn-primary"><i class="fa fa-play-circle" aria-hidden="true"></i> Assinar caixa</a> ou <a href="adicionarCarrinho?id=3" type="submit" class="btn btn-primary"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Comprar Avulso</a>
                                    </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="checkbox">
                            <label>
                                Você deseja:
                                    <div class="modal-footer">
                                        <a href="assinar?id=2" type="submit" class="btn btn-primary"><i class="fa fa-play-circle" aria-hidden="true"></i> Assinar caixa</a> ou <a href="adicionarCarrinho?id=2" type="submit" class="btn btn-primary"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Comprar Avulso</a>
                                    </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="checkbox">
                            <label>
                                Você deseja:
                                    <div class="modal-footer">
                                        <a href="assinar?id=1" type="submit" class="btn btn-primary"><i class="fa fa-play-circle" aria-hidden="true"></i> Assinar caixa</a> ou <a href="adicionarCarrinho?id=1" type="submit" class="btn btn-primary"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Comprar Avulso</a>
                                    </div>
                            </label>
                        </div>
                    </div>
