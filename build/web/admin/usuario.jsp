    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form method="POST" action="../cadastrarUsuario">
          ...
          <div class="form-group">
            <div class="form-label-group">
            <select name="perfil" id="perfil" class="custom-select custom-select-sm form-control form-control-sm">
            ...
            <div class="form-group">
            <div class="form-label-group">
            <select name="situacao" id="situacao" class="custom-select custom-select-sm form-control form-control-sm">
