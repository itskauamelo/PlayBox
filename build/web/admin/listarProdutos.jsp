...
<html>
    ...
    <head>
        ...
        <title>PlayBox - Listar Produto</title>
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <table id="tabela">
                        ...
                        <c:forEach items="${todosProdutos}" var="p">
                            <tr>
                                ...
                                <td class="conteudo" align="center"><a href="iniciarEdicaoProduto?id=${p.id}"><img style="height: 25px; width: 25px;"src="images/5594.png" alt=""  id="iconTable"/></a>        <a onclick="return valida()" href="excluirProduto?id=${p.id}"><img style="height: 25px; width: 25px;" src="images/5599.png" alt="" id="iconTable"/></a></td>
                            </tr>
                        </c:forEach>
                    </table>
                    ...
                    <script>
                        function valida() {
                            var resultado = confirm("Deseja desativar este produto?");
                            if (resultado == true) {
                                return true;
                            } else {
                                return false;
