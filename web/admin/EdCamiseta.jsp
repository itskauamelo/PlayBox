...
<html>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
            ...
            <a class="navbar-brand mr-1" href="admin/index.jsp">PlayBox</a>
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <form onsubmit="return valida()" method="POST" action="editarCamiseta">
                    ...
                    <script>
                        function valida() {
                            var resultado = confirm("Deseja alterar camiseta?");
                            if (resultado == true) {
                                return true;
                            } else {
                                return false;
