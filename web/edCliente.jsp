                    ...
                    <div class="col-cadastro" style="margin-top: -300px;">
                        ...
                        <form method="POST" action="editarCliente">
                            ...
                            <div style="margin-left: 340px;">
                                <button onclick="return confirmacao()" class="btn btn-primary" title="Criar Conta" id="btngavar" type="submit" name="gravar" value="Gravar"><i class="fa fa-plus" aria-hidden="true"></i> Alterar</a>
                            </div>
                        </form>
                    </div>
                </div>
